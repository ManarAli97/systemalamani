<?php  $this->publicHeader($this->langSite('ads'));  ?>
    ...
    <div class="container">
        <div class="section_1">
            ...
            <div class="news_list_her">
                <span> <?php echo  $this->langSite('ads')  ?>  </span>
            </div>
            <br>
    ...
    <script>
        ...
        $('#pagination-demo').twbsPagination({
            ...
            onPageClick: function (event, page) {
                ...
                window.location.href='<?php echo url .'/'.$this->folder ?>/view_ads/'+page
            },

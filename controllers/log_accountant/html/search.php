...
<table class="table table-striped display d-table  set_text_table" id="example">
    ...
    <tr>
        ...
        <th scope="col">    المبلغ  من الزبائن  (حسب التاريخ) </th>
        <th scope="col">    المبلغ المسحوب   </th>
        <th scope="col">    المبلغ المسحوب  (حسب التاريخ)  </th>
        <th scope="col">    المبلغ المدفوع من القاصة  </th>
        <th scope="col">    المبلغ المدفوع من القاصة  (حسب التاريخ) </th>
        <th scope="col">    المبلغ المدفوع الى القاصة  </th>
        <th scope="col">    المبلغ المدفوع الى القاصة  (حسب التاريخ) </th>
        <th scope="col">    مبالغ الشراء من الزبائن   </th>
        <th scope="col">    مبالغ الشراء من الزبائن  (حسب التاريخ)  </th>
        <th scope="col">   المجموع </th>
        <th scope="col">   المجموع (حسب التاريخ) </th>
        <th scope="col">    عدد الفواتير  </th>
        <th scope="col">    عدد الفواتير  (حسب التاريخ) </th>
        <th scope="col">    سحب  </th>
    ...
    <tr>
        <td><?php echo $this->UserInfo($row['id_user']) ?></td>
        <td><?php echo number_format($row['all_money_bill']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['from_customers_bill_date']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['all_discount']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['discount_date']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['sumAddFromMoney_clipper_all']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['sumAddFromMoney_clipper_date']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['sumDiscountFromMoney_clipper_all']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['sumDiscountFromMoney_clipper_date']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['purchase_customer_all']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['purchase_customer_date']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['sumAll']) .' د.ع ' ?></td>
        <td><?php echo number_format($row['sumDate']) .' د.ع ' ?></td>
        <td>
            <div style='text-align: center;font-size: 23px;'>
                <a class='btn btn-warning' href="<?php echo url .'/'.$this->folder ?>/bill/<?php echo $row['id_user'] ?>">   <?php echo  $row['sumbill']   ?> </a>
            </div>
        </td>
        <td>
            <div style='text-align: center;font-size: 23px;'>
                <a class='btn btn-warning' href="<?php echo url .'/'.$this->folder ?>/bill/<?php echo $row['id_user'] ?>">   <?php echo  $row['sumbill_date'] ?> </a>
            </div>
        </td>
        <td>

           <?php  if ($this->permit('disaccount', 'log_accountant')) { ?>

            <div style='text-align: center'>
                <button class='btn class_delete_row'   data-toggle='modal' data-target='#exampleModal_edit' data-id='{$id}' data-id_user='<?php echo $row['id_user'] ?>' data-money='<?php echo  $row['sumAll'] ?>'   >
        ...
        <td>
            <div style='text-align: center;'>
                <a href="<?php echo url .'/'.$this->folder ?>/log_discount/<?php echo $row['id_user'] ?>">  سجل السحب </a>
            </div>
        </td>

        ...
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <?php  } } ?>
                    <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('Add_parts') ?>  </li>
                </ol>
            </nav>
...
<div class="col">
     ...
     <form action="<?php echo url.'/'.$this->folder ?>/add_parts/<?php echo $id ?>" method="post">
         <div class="form-row">

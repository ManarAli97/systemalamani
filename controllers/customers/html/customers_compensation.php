    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> تعويض الزبائن (واجهة الكول سنتر)</li>
            </ol>
        </nav>
        <hr>
    </div>
...
<div class="form-group row">
    <div class="col-md-3">
        <a href="<?php echo url . '/' . $this->folder ?>/add_customers_compensation"><button type="button" id="create_groups" class="btn btn-success">اضافة</button></a>
        <a href="<?php echo url . '/' . $this->folder ?>/show_all_customers_compensation"><button type="button" id="create_groups" class="btn btn-success">اضهار الكل</button></a>
    </div>
</div>
<div class="row">
    <div class="col">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#example').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url . '/' . $this->folder ?>/customers_compensation_index_processing",
            info: false,

...
<div class="row">
    ...
    <div class="col-lg-9">
        <a  href="<?php echo url .'/'.$this->folder?>" role="button"    class="btn btn-primary btn-sm">   رجوع </a>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing/<?php echo $id  ?>/<?php   echo $from_date_stm .'/'.$to_date_stm  ?>",
            info:false,
...
<form action="<?php echo url.'/'.$this->folder?>" method="get">
    ...
    <div class="row align-items-end">
        ...
        <div class="col-auto">
            ...
            <a href="<?php echo url.'/'.$this->folder?>/bills/<?php echo $id  ?>" class="btn btn-success" ><i class="fa fa-refresh"></i></a>
        </div>
    </div>

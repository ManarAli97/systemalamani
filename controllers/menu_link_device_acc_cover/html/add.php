...
<div class="row">
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('menu_link_device_acc_cover') ?>  </li>
...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/add_menu_link_device_acc_cover" method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                    ...
                    <div class="row x_down">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <input   name="name_device[]" type="text"  class="form-control " id="validationServer01"  value=""  required/>
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-md-center ">
                    <div class="col-md-auto">
                        ...
                        <a class="btn btn-danger" href="<?php  echo url .'/'.$this->folder ?>/list_menu_link_device_acc_cover" type="button" ><?php echo $this->langControl('close')?> </a>

...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/add_mobile/<?php echo $id ?>/<?php echo $r ?>" method="post" enctype="multipart/form-data">
            <div class="form-row">
...
<!--                <div class="col-lg-6 col-sm-12 mt-5" style="margin-bottom: 30px;position: relative">-->
                            ...
                            <div class="col-12">
                                <div class="new_sub_row_first">
                                   <div class="row code_m">
                                       <div class="col-lg-3 ">
                                           <input   name="code[0][]" type="text" oninput="check_code(this)" class="form-control " id="validationServer0_code"  placeholder="<?php  echo $this->langControl('code') ?>" value="" required />
                                       </div>
                                       <div class="col-lg-3 ">

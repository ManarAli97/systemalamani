...
<div class="row">
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/list_alamani_art"><?php  echo $this->langControl('alamani_art') ?> </a></li>
...
<table id="example"  style="width:100%"   class="table table-striped display d-table"  >
    ...
    <tbody>
        ...
        <td>
           <?php  if ($this->permit('delete_alamani_art','special_offers')) { ?>
            <div style='text-align: center'>

...
<div class="row  align-items-center">
    ...
    <div class="col-auto">
        <a  href="<?php echo url .'/'.$this->folder ?>/add/<?php echo $id  ?>" role="button"    class="btn btn-primary btn-sm"> <i class="fa fa-plus" aria-hidden="true"></i>  <span><?php  echo $this->langControl('add_content') ?>  </span> </a>
    </div>
...
<script>
    ...
    $('#save').on('click',function () {
        var  id= $('#save').val();
        $.get( "<?php echo url .'/'.$this->folder ?>/delete_alamani_art/"+id, function( e ) {
            if (e !=='true')
            {
...
<script>
    ...
    function visible_news(e,id) {
        ...
        $.get("<?php echo url .'/'.$this->folder ?>/visible_alamani_art/"+vis+'/'+id, function(e){
            if (e !=='true')
            {
                window.location='<?php  echo url ."/login/user"?>'
            }

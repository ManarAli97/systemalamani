<div class="row align-items-center ">
	...
	<div class="col">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>"><?php  echo $this->langControl('rewind') ?> </a></li>
...
<table class="table table-bordered">
	...
	<tr>
        ...
        <td  onclick="copy_text(this)"  class="copyToClipboard"   title="نسخ" data-clipboard-text="<?php  echo $this->UserInfo($result['id_account_cancel'])   ?>" > <?php echo $this->UserInfo($result['id_account_cancel'])  ?> </td>
        <td  onclick="copy_text(this)"  class="copyToClipboard"   title="نسخ" data-clipboard-text="<?php  echo $this->UserInfo( $result['id_prepared_cancel']  ) ?>" > <?php echo $this->UserInfo( $result['id_prepared_cancel']  )  ?> </td>


        <td onclick="copy_text(this)"  class="copyToClipboard"   title="نسخ" data-clipboard-text="<?php  echo date('Y-m-d h:i A', $result['date_account_cancel']) ?>">  <?php echo date('Y-m-d h:i A', $result['date_account_cancel'])?>   </td>
	</tr>

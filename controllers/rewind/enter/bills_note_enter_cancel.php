    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">  فواتير مرتجع  ملغية غير  مدخلة  </li>
            </ol>
        </nav>
...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_bills_note_enter_cancel/<?php   echo $from_date_stm .'/'.$to_date_stm  ?>",
            info:false,
...
<form action="<?php echo url.'/'.$this->folder?>/bills_note_enter_cancel" method="get">
    ...
    <div class="row align-items-end">
        ...
        <div class="col-auto">
            ...
            <a href="<?php echo url.'/'.$this->folder?>/bills_note_enter_cancel" class="btn btn-success" ><i class="fa fa-refresh"></i></a>
        </div>
    </div>

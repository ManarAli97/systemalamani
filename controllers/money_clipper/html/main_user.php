    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb" >
            ...
            <ol class="breadcrumb"  >
                ...
                <li class="breadcrumb-item"> سجل الدفع والسحب  للمحاسبين الرئيسيين  </li>
    ...
    <div class="row align-items-end">
        <div class="col-auto">
            ...
            <select style="padding-top: 0" class="form-control" id="exampleFormControlSelect1"  onchange="location = this.value;">
				...
				<?php foreach ($user as $us) { ?>
                    <option value="<?php echo url.'/'.$this->folder?>/main_user/<?php echo $us['id'] ?>"   <?php  if (  $us['id']  == $id)echo 'selected'?>  >   <?php echo $us['username'] ?>  </option>
				<?php  }  ?>
            </select>
        </div>
		<?php  if ($id)  {  ?>
        <div class="col-auto">
            <div class="btn-group" role="group" aria-label="Basic example">
                <a href="<?php echo url .'/'.$this->folder ?>/main_user/<?php  echo $id ?>/0"  class="btn btn-secondary" > <?php if ($flag==0) { ?> <i class="fa fa-check-circle"></i> <?php } ?> <span>سجل الاضافة</span> </a>
                <a href="<?php echo url .'/'.$this->folder ?>/main_user/<?php  echo $id ?>/1"  class="btn btn-secondary"> <?php if ($flag==1) { ?> <i class="fa fa-check-circle"></i> <?php } ?>  <span>سجل السحب</span> </a>
            </div>
        </div>
        <?php  } ?>
...
<form id="add_money_to_main_user" action="<?php echo url.'/'.$this->folder?>/add_money_to_main_user/<?php echo $id ?>" method="post">
...
<form id="withdraw_amount_money_to_main_user"  action="<?php echo url.'/'.$this->folder?>/withdraw_amount_money_to_main_user/<?php echo $id ?>" method="post">
    ...
    <script>
        ...
        $("#add_money_to_main_user").submit(function(e) {
        ...
        $("#withdraw_amount_money_to_main_user").submit(function(e) {
...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_add_money_to_main_user/<?php  echo $id?>/<?php  echo $flag?>",
            info:false,

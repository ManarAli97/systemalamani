...
<?php  } else {  ?>
    <?php  $this->publicHeader($this->langSite('computer'));  ?>
<?php } ?>
            ...
            <div class="col-lg-9">
                ...
                <br>
                    ...
                    <nav aria-label="breadcrumb" class="path_bread">
                        <ol class="breadcrumb">
                            ...
                            <?php  } } ?>
                            <?php  } else {  ?>
                                <li class="breadcrumb-item active">  <?php echo $this->langSite('computer') ?>  </li>
                ...
                <?php  if (!empty($class_computer)) {  ?>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <ul class="tags-list">
                                    ...
                                    <?php  foreach ($class_computer as $clgame) {  ?>
                                        <li><a class="btn class_computer" id="class_computer_<?php  echo $clgame['id']?>" onclick="class_computer(<?php  echo $clgame['id']?>)">  <?php  echo $clgame['title']?> </a></li>
                                    <?php  }  ?>
                    ...
                    <script>
                        ...
                        function class_computer(id) {


                            $('.class_computer').removeClass('active');
                            $('#class_computer_'+id).toggleClass('active');

                            $('.loading_range').html(' <img  src="<?php echo $this->static_file_site ?>/image/site/loding.gif" >');
                            $.get( "<?php  echo url .'/'.$this->folder?>/class_computer/"+id+"/<?php echo $id ?>", function( data ) {
                                $('.loading_range').empty();
                                if (data)
                                {
                                    $('.range_data').html(data)
    ...
    <script>
     ...
     function  like_d(id) {
            ...
            $.get('<?php echo url ?>/computer/like_d/'+id, function(data){
                if (data==='done')
                {
      ...
      function  unlike_d (id) {
          ...
          $.get('<?php echo url ?>/computer/unlike_d/'+id, function(data){
              if (data==='done')
              {

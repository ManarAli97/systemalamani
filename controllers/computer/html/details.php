<?php $this->publicHeader($result['title']); ?>
                ...
                <div class="phoneModel heddinSm" style="position: relative">
                    ...
                    <div class="control_slider control_slider_inside">
                        <div class="row">
                            ...
                            <div class="col-auto  ">
                                <?php echo $this->langSite('computer') ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="details_computer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="details_info_computer">
                                    ...
                                    <div class="choose_color_computer">
                                        <div class="t_d_m">
                                            اختيار التفاصيل
                                        </div>
    ...
    <style>
        ...
        .image_computer_show img.image_user {
            height: 350px;
            max-width: 100%;
        }

...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/edit_computer/<?php echo $id ?>" method="post" enctype="multipart/form-data">
            <div class="form-row">
	       ...
	       <br>
            ...
            <div class="row">
                ...
                <?php  foreach ($class_computer as  $key => $cgame) {  ?>
                    <div class="col-lg-3 col-md-4 col-sm-12  ">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="class_computer[]" value="<?php  echo $cgame['id']  ?>"   <?php if (in_array($cgame['id'],$clgame_id))  echo 'checked'?>  class="custom-control-input" id="customCheck_<?php  echo $key  ?>">
            ...
            <div class="container">
                <div class="row justify-content-md-center ">
                    <div class="col-md-auto">
                        <input  class="btn btn-primary" id="save_btn_card" value="حفظ" type="submit" name="submit">

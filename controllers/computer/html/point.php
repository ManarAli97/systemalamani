    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" >  اضافة  نقاط المادة  </li>
...
<form    action="<?php echo url.'/'.$this->folder ?>/point"  method="post" enctype="multipart/form-data">

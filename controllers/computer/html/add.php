...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/add_computer/<?php echo $id ?>/<?php echo $r ?>" method="post" enctype="multipart/form-data">
            <div class="form-row">
            ...
            <div class="row">
                ...
                <?php  foreach ($class_computer as  $key => $cgame) {  ?>
                    <div class="col-lg-3 col-md-4 col-sm-12  ">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="class_computer[]"    value="<?php  echo $cgame['id']  ?>" class="custom-control-input" id="customCheck_<?php  echo $key  ?>">

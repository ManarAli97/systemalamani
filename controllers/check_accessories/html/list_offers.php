...
<div class="row justify-content-between">
    ...
    <div class="col-auto">
        <?php 	if ($this->permit('delete_all', $this->folder)) { ?>
            <div class="text-left">
                <button class="btn btn-danger" onclick="delete_all()"> <i class="fa fa-trash"></i> <span>حذف الكل</span></button>
            </div>
...
<script>
    ...
    $('#save').on('click',function () {
        var  id= $('#save').val();
        $.get( "<?php echo url .'/'.$this->folder ?>/delete_check_accessories/"+id, function( e ) {
            if (e !=='true')
            {
...
<script>
    ...
    function visible_news(e,id) {
        ...
        $.get("<?php echo url .'/'.$this->folder ?>/visible_check_accessories/"+vis+'/'+id, function(e){
            if (e !=='true')
            {
                window.location='<?php  echo url ."/login/user"?>'
            }

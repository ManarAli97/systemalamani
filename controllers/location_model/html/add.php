...
<nav>
	<div class="nav nav-tabs" id="nav-tab" role="tablist">
		<a class="nav-item nav-link show active  title_normal" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">   <span> رفع ملف الاكسيل مواقع قسم</span> <span><?php  echo $this->langControl($model)?></span>  </a>

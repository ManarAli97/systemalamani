...
<div class="row">
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <?php  } } ?>
                <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('Edit_groups') ?>  </li>
    ...
    <div class="row">
        <div class="col">
            ...
            <form action="<?php echo url.'/'.$this->folder ?>/edit_groups/<?php echo $id ?>" method="post">
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="col-auto ">
                        ...
                        <input name="date"  type="datetime-local"     data-toggle="tooltip" data-placement="top" title="السنة/اليوم/الشهر"    value="<?php echo  date('Y-m-d\TH:i:s', $data['date'])  ?>"  class="form-control is-valid" id="validationServer02"     required>
                    </div>
                </div>

...
<div class="col-12">
               ...
               <a class="btn top_view_groups">
                            ...
                            <div class="container_tab_slider">
                                ...
                                <div id="carouselExampleIndicators_groups_hospital_new_groups"
                                     class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">

                                        <?php foreach ($new_groups_chunk as  $key => $array_chunk_groups) { ?>
                                            ...
                                            <div class="row">
                                                <div class="col-auto" style="padding-left: 2px;padding-right: 0">
                                                    <a class="carousel-control-prev prev_and_prev"
                                                       href="#carouselExampleIndicators_groups_hospital_new_groups"

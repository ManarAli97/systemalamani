...
<table id="example"  style="width:100%"   class="table table-striped display d-table"  >
    ...
    <tbody>
        ...
        <td>
            <?php   if ($this->permit('visible','special_how_use')) { ?>
        ...
        <td>
          <?php   if ($this->permit('special','special_how_use')) { ?>
            <div style='text-align: center'>
        ...
        <td>
            <?php  if ($this->permit('edit','special_how_use')) { ?>
        ...
        <td>
           <?php  if ($this->permit('delete_services','special_how_use')) { ?>
            <div style='text-align: center'>
...
<div class="fixed-bottom"> <div class="center_button text-center">
        ...
        <a class="btn btn-danger" href="<?php  echo url .'/'.$this->folder?>/list_special_how_use" data-toggle="tooltip" data-placement="left" title="رجوع الى القاعدة"><i class="fa fa-reply"></i> </a>

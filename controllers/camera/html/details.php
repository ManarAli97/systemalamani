<?php $this->publicHeader($result['title']); ?>
            ...
            <div class="col-lg-3">
                ...
                <script>
                    ...
                    function  like_d(id) {
                        ...
                        $.get('<?php echo url ?>/camera/like_d/'+id, function(data){
                            if (data==='done')
                            {
                    ...
                    function  unlike_d (id) {
                        ...
                        $.get('<?php echo url ?>/camera/unlike_d/'+id, function(data){
                            if (data==='done')
                            {
    ...
    <style>
        ...
        .image_camera_show img.image_user {
            height: 350px;
            max-width: 100%;
        }

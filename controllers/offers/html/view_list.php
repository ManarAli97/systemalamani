<?php  $this->publicHeader($this->langSite('offers'));  ?>
    ...
    <div class="container">
        <div class="section_1">
            ...
            <div class="news_list_her">
                <span> <?php echo  $this->langSite('offers')  ?>  </span>
            </div>
            <br>
            ...
            <div class="row">
                <?php   foreach ($offers as $d) {  ?>

                <div class="col-lg-3  col-md-4 col-sm-6">
                    <div class="box_list_offers">
...
<style>
    ...
    .box_list_offers:hover .title_offers
    {
        background: #00a3c8cc;
        color: #fff;
        padding: 6px;
    ...
    <script>
        ...
        $('#pagination-demo').twbsPagination({
            ...
            onPageClick: function (event, page) {
                ...
                window.location.href='<?php echo url .'/'.$this->folder ?>/view_offers/'+page
            },

...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_offers_active/<?php  echo $model ?>/<?php  echo $id ?>/<?php echo $id_c_of ?>",
            info:true,
        ...
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" >  عروض مفعلة </li>
                </ol>
            </nav>
...
<form action="<?php  echo  url .'/'.$this->folder ?>/offers_active" method="get">

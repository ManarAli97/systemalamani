...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_offers_deleted/<?php  echo $model ?>/<?php  echo $id ?>/<?php echo $id_c_of ?>",
            info:true,
...
<form action="<?php  echo  url .'/'.$this->folder ?>/offers_deleted" method="get">

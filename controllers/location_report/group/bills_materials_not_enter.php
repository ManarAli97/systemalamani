...
<div class="row justify-content-between">
    ...
    <div class="col-auto">
        ...
        <form action="<?php echo url.'/'.$this->folder?>/export_group?g=<?php  echo $number?>" method="get">
            ...
            <div class="row align-items-end">
                ...
                <div class="col-auto">
                    ...
                    <a href="<?php echo url.'/'.$this->folder?>/export_group?g=<?php  echo $number?>" class="btn btn-success" ><i class="fa fa-refresh"></i></a>
                </div>
            </div>

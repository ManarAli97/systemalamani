...
<div class="row">
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('model_big_q') ?>  </li>
...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/add_model_big_q" method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                    ...
                    <div class="row x_down">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <label for="validationServer01"> رمز المادة </label>
                            <input   name="code[]" type="text"  class="form-control " id="validationServer01"  value=""  required/>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <label for="exampleFormControlSelect0">  القسم </label>
                            <select style="padding-top: 0" name="model[]" class="form-control" id="exampleFormControlSelect0">
            ...
            <div class="container">
                <div class="row justify-content-md-center ">
                    <div class="col-md-auto">
                        ...
                        <a class="btn btn-danger" href="<?php  echo url .'/'.$this->folder ?>/list_model_big_q" type="button" ><?php echo $this->langControl('close')?> </a>
...
<script>
    ...
    $('.addPs').click(function() {
        ...
        $('.blockPs:last').before(`<div class="blockPs">
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-12">
                            <label for="exampleFormControlSelect${count}">  القسم </label>
                            <select style="padding-top: 0" name="model[]" class="form-control" id="exampleFormControlSelect${count}">
                                <?php  foreach ( $this->category_website as $key=>$model ) {  ?>
                                    <option value="<?php echo $key ?>" > <?php  echo $model ?></option>
                                <?php   }  ?>
                            </select>

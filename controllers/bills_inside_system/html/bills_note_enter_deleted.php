    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"> <?php  echo $this->langControl('bills_crystal_note_enter_deleted') ?> </li>
            </ol>
        </nav>
...
<script>
    $(document).ready(function() {
        ...
        var table= $('#example').DataTable( {
            ...
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_note_enter_deleted/<?php   echo $from_date_stm .'/'.$to_date_stm  ?>",
            <?php  } ?>
            info:false,
            ...
            "order": [[ 2, 'asc'] ], orderCellsTop: true,
...
<form action="<?php echo url.'/'.$this->folder?>/bills_crystal_note_enter_deleted" method="get">
    ...
    <div class="row align-items-end">
        ...
        <div class="col-auto">
            ...
            <a href="<?php echo url.'/'.$this->folder?>/bills_crystal_note_enter_deleted" class="btn btn-success" ><i class="fa fa-refresh"></i></a>
        </div>
    </div>

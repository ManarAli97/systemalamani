...
<div class='row   align-items-end'>
    <div class='col-auto'  >
        ...
        <input placeholder="ادخال رقم فاتورة كرستال" id='numberBill_<?php  echo $number?>' value="<?php  echo $result['crystal_bill'] ?>"  type='text' class='form-control' name='crystal_bill' required>
    </div>
    <div class='col-auto'  >
        <button type='submit' id='btn_in_bill_<?php  echo $number?>' onclick=saveBill('<?php  echo $number?>')  name='submit' class='btn btn-success'>تعديل</button>
    </div>
</div>

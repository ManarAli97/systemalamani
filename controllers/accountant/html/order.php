    ...
    <div class="col-12">
        ...
        <?php  if (!empty($request)) { ?>
            ...
            <div class="row justify-content-center">
                ...
                <button class="btn btn-warning"  disabled    id="bill_casher" onclick="print_bill_casher()"> <i class="fa fa-print"></i> <span> طباعة فاتورة كاشير  </span>
...
<script>
    ...
    function  processing_request(number_bill) {
        ...
        if (confirm('هل استلمت المبلغ من الزبون ؟')) {

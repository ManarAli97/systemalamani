...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_camera",
            info:false,
    ...
    <div class="row">
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/list_excel_camera"><?php  echo $this->langControl('excel') ?> </a></li>

                    <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('view_content') ?>  </li>
                    <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('camera') ?>  </li>
                </ol>
            </nav>
...
<div class="row align-items-end justify-content-between">
    ...
    <div class="col-auto">
        ...
        <?php  } else {  ?>
            <a  href="<?php echo url .'/'.$this->folder ?>/add_camera" role="button"    class="btn btn-primary btn-sm"> <i class="fa fa-plus" aria-hidden="true"></i>  <span><?php  echo $this->langControl('add_excel') ?>  </span> </a>

        <?php } ?>
        <a  href="<?php echo url .'/'.$this->folder ?>/archives/camera" role="button"    class="btn btn-warning btn-sm"> <i class="fa fa-archive" aria-hidden="true"></i>  عرض الارشيف  </span> </a>

        <?php  if ($code_upload) {  ?>
            <a  href="<?php echo url .'/'.$this->folder ?>/code_not_upload/camera" role="button"    class="btn btn-danger btn-sm"> <i class="fa fa-times" aria-hidden="true"></i>  مواد غير مرفوعة   </span> </a>
...
<script>
    ...
    $('#save').on('click',function () {
        var  id= $('#save').val();
        $.get( "<?php echo url .'/'.$this->folder ?>/delete_excel_camera/"+id, function( e ) {
            if (e !=='true')
            {

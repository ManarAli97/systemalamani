...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_computer_location_set_not",
            info:false,
        ...
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> <?php  echo $this->langControl('computer') ?>  </li>
...
<div class="row">
    ...
    <div class="col-lg-9">
        ...
        <a  href="<?php echo url .'/'.$this->folder ?>/add_computer" role="button"    class="btn btn-primary btn-sm"> <i class="fa fa-plus" aria-hidden="true"></i>  <span><?php  echo $this->langControl('add_content') ?>  </span> </a>

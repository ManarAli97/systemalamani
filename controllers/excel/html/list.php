    ...
    <div class="row">
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/list_excel/<?php echo $model ?>"><?php  echo $this->langControl('excel') ?> </a></li>
...
<div class="row align-items-end justify-content-between">
    ...
    <div class="col-auto">
        ...
        <?php  } else {  ?>
        <a    href="<?php echo url .'/'.$this->folder ?>/add/<?php echo $model ?>"   class="btn btn-primary btn-sm"> <i class="fa fa-plus" aria-hidden="true"></i>  <span><?php  echo $this->langControl('add_excel') ?>  </span> </a>

        <?php } ?>
        <a  href="<?php echo url .'/'.$this->folder ?>/archives/<?php echo $model ?>" role="button"    class="btn btn-warning btn-sm"> <i class="fa fa-archive" aria-hidden="true"></i>  <span>  عرض الارشيف</span> </a>

        <?php  if ($code_upload) {  ?>
            <a  href="<?php echo url .'/'.$this->folder ?>/code_not_upload/<?php echo $model ?>" role="button"    class="btn btn-danger btn-sm"> <i class="fa fa-times" aria-hidden="true"></i>   <span>  مواد غير مرفوعة </span> </a>
...
<!-- Modal -->
<div class="modal fade  bd-example-modal-lg" id="exampleModalLocation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    ...
    $('#save').on('click',function () {
        var  id= $('#save').val();
        $.get( "<?php echo url .'/'.$this->folder ?>/delete_excel/"+id+"/<?php echo $model ?>", function( e ) {
            if (e !=='true')
            {

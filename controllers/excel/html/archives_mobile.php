...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_archives/<?php   echo  $model .'/'. $from_date_stm .'/'.$to_date_stm .'/'.$number_bill ?>",
            info:false,
        ...
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl("excel_{$model}_archives") ?>  </li>
...
<form action="<?php echo url.'/'.$this->folder?>/archives/<?php echo  $model ?>" method="get">
    ...
    <div class="row align-items-end">
        ...
        <div class="col-auto">
           رقم الفاتورة
            <input autocomplete="off"  type="number" name="number_bill" class="form-control" value="<?php  echo $number_bill ?>"   >
        </div>
        <div class="col-auto">
            <button type="submit" class="btn btn-warning" >بحث</button>
            <a href="<?php echo url.'/'.$this->folder?>/archives/<?php echo  $model ?>" class="btn btn-success" ><i class="fa fa-refresh"></i></a>
        </div>
    </div>

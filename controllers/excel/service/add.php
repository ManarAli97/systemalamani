...
<div class="row">
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/add_service"> رفع ملف اكسل الحافظات </a></li>
...
<div class="tab-content" id="nav-tabContent">
    ...
    <div class="tab-pane fade show active normal" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        ...
        <form    action="<?php echo url.'/'.$this->folder ?>/add_service"  method="post" enctype="multipart/form-data">
            ...
            <div class="container">
                <div class="row justify-content-center ">
                    <div class="col-auto">
                        ...
                        <?php  if ($code_upload) {  ?>
                            <a   href="<?php echo url .'/'.$this->folder?>/code_not_upload/service" class="btn  btn-primary"  > لايمكن الرفع , توجد مواد غير مرفوعة </a>
                        <?php } else { ?>
    ...
    <div class="tab-pane fade  cumulative  <?php  if (!$this->permit('delete_and_replace',$this->folder)) echo 'show active' ?> " id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
        ...
        <form    action="<?php echo url.'/'.$this->folder ?>/service_cumulative_upload"  method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="col-md-12 mb-12 lg-12">
                    ...
                    <span style="color: red;font-size: 14px;" id="files_service_cumulative_upload"> </span>
                    <br>

                    <textarea name="files_service_cumulative_upload" id="files_data_mobile_cumulative_upload" hidden  class="form-control"></textarea>
                    <label class="label_files" >    رفع ملف الاكسل فقط  </label>
                    <div class="fileupload-wrapper">
                        <div id="myUpload_files_service_cumulative_upload">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            $("#myUpload_files_service_cumulative_upload").bootstrapFileUpload({
                    url: "<?php echo url ?>/files/save_files",
                    inputName: 'files',
                    multiFile: false,
                    multiUpload: true,

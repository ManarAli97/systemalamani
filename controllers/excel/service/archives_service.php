...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_archives_service/<?php   echo $from_date_stm .'/'.$to_date_stm .'/'.$number_bill ?>",
            info:false,
    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('excel_service_archives') ?>  </li>
...
<form action="<?php echo url.'/'.$this->folder?>/archives_service" method="get">
    ...
    <div class="row align-items-end">
        ...
        <div class="col-auto">
            ...
            <a href="<?php echo url.'/'.$this->folder?>/archives_service" class="btn btn-success" ><i class="fa fa-refresh"></i></a>
        </div>
    </div>

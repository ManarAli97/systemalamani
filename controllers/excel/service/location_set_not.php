...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_service_location_set_not",
            info:false,
...
<div class="row">
    ...
    <div class="col-lg-9">
        ...
        <a  href="<?php echo url .'/'.$this->folder ?>/add_service" role="button"    class="btn btn-primary btn-sm"> <i class="fa fa-plus" aria-hidden="true"></i>  <span><?php  echo $this->langControl('add_content') ?>  </span> </a>
        <a  href="<?php echo url .'/'.$this->folder ?>/archives_service" role="button"    class="btn btn-warning btn-sm"> <i class="fa fa-archive" aria-hidden="true"></i>  عرض الارشيف  </span> </a>

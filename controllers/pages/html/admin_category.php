    ...
    <div class="row">
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/admin_category"><?php  echo $this->langControl('pages') ?> </a></li>
            ...
            <div class="row setting_padding_Col">
                <div class="col">
                    ...
                    <div class="dropdown-menu menu_drop" >
                        <a class="dropdown-item" href="<?php echo url ?>/pages/edit_category/<?php echo $cat['id'] ?>"><?php echo $this->langControl('edit_category') ?></a>
                  </div>
                    </div>
...
<script>
    ...
    $('#save').on('click',function () {
        var  id= $('#save').val();
        $.post( "<?php echo url ?>/pages/delete/"+id, function( data ) {
            $('.card_'+id).remove();
    ...
    function vis_cat(e,id) {
        ...
        $.get("<?php echo url ?>/pages/visible/"+vis+'/'+id, function(){ })
    }

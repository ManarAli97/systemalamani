...
<?php foreach ($data as $cat) { ?>
    ...
    <div class="card" >
        <a  href="<?php echo url ?>/gallery/list_gallery/<?php echo $cat['id'] ?>">
            ...
            <div class="row setting_padding_Col">
                <div class="col">
                    ...
                    <div class="dropdown-menu menu_drop" >
                        <a class="dropdown-item" href="<?php echo url ?>/gallery/edit_category/<?php echo $cat['id'] ?>"><?php echo $this->langControl('edit_category') ?></a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?php echo url ?>/gallery/list_gallery/<?php echo $cat['id'] ?>"><?php echo $this->langControl('view_content') ?></a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?php echo url ?>/gallery/add_gallery/<?php echo $cat['id'] ?>"><?php echo $this->langControl('add_to_category') ?> </a>
                    </div>
                    </div>
...
<script>
    ...
    $('#save').on('click',function () {
        var  id= $('#save').val();
        $.post( "<?php echo url ?>/gallery/delete/"+id, function( data ) {
            $('.card_'+id).remove();
    ...
    function vis_cat(e,id) {
        ...
        $.get("<?php echo url ?>/gallery/visible/"+vis+'/'+id, function(){ })
    }

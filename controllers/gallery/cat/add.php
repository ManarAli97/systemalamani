...
<div class="row">
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>"><?php  echo $this->langControl('gallery') ?> </a></li>
...
<form  id="randomInsert" action="<?php echo url ?>/gallery/add_category/<?php  echo $id ?>" method="post"  >
    <div class="form-row">
    ...
    <div class="form-row">
        <div class="col-md-12 mb-12 lg-12">
            <label for="validationServer02">   موقع القسم  <span style="color: red;font-size: 14px;" id="index"> </span>  </label>
            <input name="index" class="form-control"  id="validationServer02"  value="<?php  echo $data['index']  ?>" type="text">
        </div>
    </div>

...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_active/<?php  echo $model ?>/<?php  echo $id ?>",
            info:true,
        ...
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <?php  echo $category ?>
                     <li class="breadcrumb-item active" aria-current="page" > تجميعات مفعلة </li>
                </ol>
            </nav>
...
<form action="<?php  echo  url .'/'.$this->folder ?>/list_computer_assembly_active" method="get">

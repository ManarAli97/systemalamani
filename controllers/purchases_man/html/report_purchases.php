    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('report_purchases') ?>  </li>
            </ol>
        </nav>
...
<?php  foreach ($categ as $catx ) { ?>
    ...
    $(document).ready(function() {
        ...
        $('#example<?php  echo $catx ?>').DataTable( {
            ...
            serverSide:     true,
            fixedColumns:false,
            "ajax": "<?php echo url .'/'. $this->folder ?>/processing_report_purchases/<?php  echo $catx ?>/<?php  echo $date ?>",
            info:false,

    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/list_delegate_man">    مندوبين المشتريات  </a></li>
...
<form action="<?php  echo  url .'/'.$this->folder ?>/view_purchases/<?php  echo $id ?>" method="get">
...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'. $this->folder ?>/processing_view_purchases/<?php  echo $id .'/'. $date ?>",
            info:false,

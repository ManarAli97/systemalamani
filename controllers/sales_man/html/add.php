...
<div class="row">
    ...
    <div class="col-auto">
        ...
        <select name="region" class="custom-select mr-sm-4" id="inlineFormCustomSelect" >
            ...
            <div class="row align-items-center x_down removeRow_<?php  echo $c_data['id'] ?>">
                ...
                <div class="col-auto align-self-center">
                    <div class="form-group" style="margin: 0;padding: 0;    margin-top: 37px;">
                        <input type="checkbox"  checked   name="selected[<?php echo $c_data['id'] ?>]" value="<?php echo $c_data['id'] ?>"  id="exampleCheck1">
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 align-self-end">
                    ...
                    <input   type="text"  name="price[<?php echo $c_data['id'] ?>][]"  class="form-control is-valid" id="validationServer0_color"  value=""  />
                </div>

                <div class="col-lg-2 col-md-2 col-sm-2 align-self-end">
                    <label for="validationServer0_color">  الكمية المقترحة للطلب  </label>
                    <input   name="quantity[<?php echo $c_data['id'] ?>][]" type="number"  class="form-control is-valid" id="validationServer0_color"  value=""     />
                </div>
                ...
                <div class="col-10">
                 <br>
                        <div class="form-group form-check">
                            <textarea  placeholder="ملاحظة"  name="note[<?php echo $c_data['id'] ?>][]"   class="form-control" ></textarea>
                        </div>

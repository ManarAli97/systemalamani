        ...
        <form id="idForm" action="<?php echo url .'/'.$this->folder ?>/note" method="post">
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <div id="editor">
                        <textarea  name="dhuquk_ahlaa" id='edit' style="margin-top: 30px;" placeholder="<?php echo $this->langControl('write_her') ?>"><?php  echo $this->setting->get('dhuquk_ahlaa'); ?></textarea>
                    </div>
...
<?php foreach ($data as $cat) { ?>
    ...
    <div class="card" >
        <a  href="<?php echo url .'/'.$this->folder ?>/list_dhuquk_ahlaa/<?php echo $cat['id'] ?>">
            ...
            <div class="row setting_padding_Col">
                <div class="col">
                    ...
                    <div class="dropdown-menu menu_drop" >
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?php   echo url .'/'.$this->folder   ?>/list_dhuquk_ahlaa/<?php echo $cat['id'] ?>"><?php echo $this->langControl('view_content') ?></a>

            ...
            <?php  if (!empty($rewind_active)) { ?>
                ...
                <table border='1' class="  tableBill  tableBill_casher  table-bordered  "  style="width: 100%;border-collapse: collapse;"   >
                    ...
                    <tr>
                        ...
                        <td style="width: 40px;padding : 0.65rem !important;font-weight: bold;font-size: 20px;"> اللون  </td>
                    ...
                    <?php   foreach ($rewind_active as $rows)  {  ?>
                        <tr  >
                            ...
                            <td   style='padding : 0.65rem !important;font-size: 18px;'><?php  echo $rows['item_name'] ?></td>
                            <td  style='padding : 0.65rem !important;font-size: 18px;'><?php  echo $rows['color']   ?>  </td>
                            <td  style='padding : 0.65rem !important;font-size: 18px;'><?php  echo $rows['number'] ?></td>
                            <td style="padding : 0.65rem !important;font-size: 18px;" ><?php  echo number_format($rows['price_new']) ?>    </td>
...
<script>
    ...
    function cancel_rewind(id) {
        if(confirm('هل انت متأكد من الغاء الاسترجاع ? ')) {
            $.get("<?php echo url . '/' . $this->folder ?>/cancel_rewind3/" + id+"/<?php echo $number_bill?>", function (data) {

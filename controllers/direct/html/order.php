        ...
        <?php  if (!empty($request)) { ?>
                        ...
                        <div class="row justify-content-end">
                          <?php  if ($this->ch_smart_prepared($this->userid)) {  ?>
                            ...
                            <div class="col-auto"  style="margin-left: 5px">
                                <button type="submit" id="goOk" class="btn btn-warning" name="submit" value="submit">تجهيز</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <table class="requ_on table table-striped" border>
                ...
                <tr style="background: #125da9;color: #ffffff">
                    ...
                    <th  style="display: none">   متغيات   </th>
...
var edit_serial='0'
    ...
    function  return_order_plus(id_order,table,colde,id_user,color,id_row,number_bill) {

        $('#plus_x_'+id_order).attr('disabled','disabled');

        $.ajax({
            type: 'GET',
            url: "<?php  echo url . '/' . $this->folder ?>/return_order_plus/" + table + "/" + colde + "/" + id_user+ "/" + id_row,
            cache: false,
            data: {color:color,number_bill:number_bill},
            success: function (response) {

        ...
        <div class="print_bill_casher"  >
            <?php  if (!empty($request)) { ?>
                ...
                <table border='1' class="  tableBill  tableBill_casher  table-bordered  "  style="width: 100%;border-collapse: collapse;"  >
                    <thead>
                    <tr>
                        <th style='padding : 0.75rem !important;font-weight: bold;font-size: 20px;'>اسم المادة</th>
                        <th style='padding : 0.75rem !important;font-weight: bold;font-size: 20px;'>  حجم الذاكره </th>
                        <th style='padding : 0.75rem !important;font-weight: bold;font-size: 20px'>  اللون </th>
                        <th style='padding : 0.75rem !important;font-weight: bold;font-size: 20px'>  الكمية  </th>
                        <th style='padding : 0.75rem !important;font-weight: bold;font-size: 20px'>السعر  </th>
                    ...
                    <?php    foreach ($request as $key => $rows)  {  ?>
                        <tr  class="<?php  if ($rows['prepared']==1) echo 'not_prepared'?>" >
                            <td style='padding : 0.75rem !important;font-size: 18px'><?php  echo $rows['title'] ?></td>
                            <td style='padding : 0.75rem !important;font-size: 18px'><?php  echo $rows['size'] ?></td>
                            <td style='padding : 0.75rem !important;font-size: 18px'><?php  echo $rows['color_name']   ?>  </td>
                            <td style='padding : 0.75rem !important;font-size: 18px'><?php  echo $rows['number'] ?></td>
                            <td  style="font-size:20px;padding : 0.75rem !important" ><?php  echo str_replace( 'د.ع','', $rows['price'] )  ?>  </td>
                        </tr>
                    <?php  }  ?>
                    </tbody>
                </table>
                ...
                <table style="width: 100%;border-collapse: collapse;">
                    <tbody>
                    <tr>
                        <td  > <span>    عدد المواد: </span> <span>  <?php echo  $number_type ?>  </span></td>
                        <td><span>     مجموع الكمية : </span> <span>  <?php echo  $sum_material ?>  </span></td>
                        <td><span>البائع:</span> <span>  <?php echo $seles ?>  </span></td>
                    </tr>
                    </tbody>
                </table>

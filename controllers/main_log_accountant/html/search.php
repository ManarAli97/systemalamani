...
<table class="table table-striped display d-table  set_text_table" id="example">
    ...
    <tr>
        ...
        <td>  <?php echo $usr['sum_discount']?>   د.ع  </td>
        <td>  <?php echo $usr['sum_rewind']?>    د.ع  </td>
        <td>  <?php echo $usr['addMoney_clipper']?>    د.ع  </td>
        <td>  <?php echo number_format( $usr['withdrawMoney_clipper']) ?>    د.ع  </td>
        <td>  <?php echo number_format( $usr['pur_cust'] )?>    د.ع  </td>
        <td>  <?php echo $usr['sum']?>   د.ع  </td>

        <td>   <a href="<?php  echo url .'/'.$this->folder ?>/log_discount/<?php   echo $usr['id'] ?>">سجل السحب</a>  </td>

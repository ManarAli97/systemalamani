    ...
    <div class="row">
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/staff_evaluation"><?php  echo $this->langControl('staff_evaluation') ?> </a></li>
...
<script>
    ...
    $('#save').on('click',function () {
        var  id= $('#save').val();
        $.get( "<?php echo url .'/'.$this->folder ?>/delete_staff_evaluation/"+id, function( e ) {
            if (e !=='true')
            {
...
<script>
    ...
    function visible_news(e,id) {
        ...
        $.get("<?php echo url .'/'.$this->folder ?>/visible_staff_evaluation/"+vis+'/'+id, function(e){
            if (e !=='true')
            {
                window.location='<?php  echo url ."/login/user"?>'
            }

...
<!--     pagenation-->
     ...
     <link href="https://datatables.net/release-datatables/media/css/dataTables.bootstrap.css">
     <link href="https://datatables.net/release-datatables/extensions/FixedColumns/css/fixedColumns.bootstrap.css">
			 ...
			 <?php  if ($this->permit('savers','savers')) {  ?>
                 <li class="savers">  <a href="#">  <?php  echo $this->langControl('savers') ?> </a>
                     ...
                     <ul>
                         ...
                         <!--                     <li class="savers">-->
                         <!--                         <a class="savers" href="--><?php //echo url?><!--/savers/connect"> --><?php // echo $this->langControl('connect_between_cover_and_excel') ?><!-- </a>-->
                         <!--                     </li>-->
                         <!---->
                         ...
                         <!--                     <li class="savers">-->
                         <!--                         <a class="savers" href="--><?php //echo url?><!--/savers/list_product_savers"> --><?php // echo $this->langControl('product_savers') ?><!-- </a>-->
                         <!--                         <a href="--><?php //echo url ?><!--/savers/add_product_savers" class="savers" data-toggle="tooltip"-->
                         <!--                            data-placement="top" title="--><?php //echo $this->langControl('add') ?><!--"><i-->
                         <!--                                 class="fa fa-plus-circle" aria-hidden="true"></i></a>-->
                         <!--                     </li>-->

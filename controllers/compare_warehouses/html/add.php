        ...
        <form    action="<?php echo url.'/'.$this->folder ?>/add"  method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-auto" >
                    ...
                    <select  name="cat" class="custom-select mr-sm-2"  id="inlineFormCustomSelect" required>
						<?php  foreach ($this->category_website as  $key => $catg )  { ?>
                            <option value="<?php echo $key ?>"   >   <?php echo $this->langControl($catg) ?>  </option>
						<?php  } ?>
                    </select>
                    ...
                    <div class="col">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="customRadioInline1" value="1" checked  name="type" class="custom-control-input" required>
                            <label class="custom-control-label" for="customRadioInline1">  الباركود  </label>
                        </div>
                        <div class="custom-control custom-radio  custom-control-inline">
                            <input type="radio" id="customRadioInline2"  value="2" name="type" class="custom-control-input" required>

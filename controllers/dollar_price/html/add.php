...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/add_dollar_price" method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                        ...
                        <div class="row x_down">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <label for="validationServer01">  <?php  echo $this->langControl('dollar_price') ?>  </label>
                                <input   name="dollar[]" type="text"  class="form-control " id="validationServer01"  value=""  required/>
                            </div>
            ...
            <div class="container">
                <div class="row justify-content-md-center ">
                    <div class="col-md-auto">
                        ...
                        <a class="btn btn-danger" href="<?php  echo url .'/'.$this->folder ?>/list_dollar_price" type="button" ><?php echo $this->langControl('close')?> </a>

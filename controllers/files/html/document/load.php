<?php foreach ($files as $ns) {   ?>
        ...
        <div class="col-lg-3 col-md-4 card_<?php  echo $ns['id']?>"  >
            <div class="card_file">
            <div class="card-img-top document_manager" style="background-image: url(<?php echo $ns['icon'] ?>)" ></div>
            <div class="card-body">
            ...
            <div class="card-footer">
                <div class="row justify-content-between icon_">
                    <div class="col-auto">
                        <a  data-toggle="tooltip" data-placement="top" title="<?php  echo $this->langControl('change') ?>"   href="<?php  echo url .'/'.$this->folder ?>/edit_media/<?php echo $ns['id'] ?>/file" class="btn"> <i class="fa fa-refresh"></i> </a>
                    </div>

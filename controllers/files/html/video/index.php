            ...
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('videos') ?>  </li>
                    </ol>
                </nav>
            </div>
        </div>
...
<script>
    ...
    $("#myUploadImage").bootstrapFileUpload({
        url: "<?php echo url ?>/files/upload_media_files_manger",
        inputName: 'image',
        multiFile: true,
        multiUpload: true,
        fileTypes: {
        ...
        onInit: function () {
            $('#myUploadImage .btnAddFile').html(`<i class="fa fa-upload"></i>  <span>&nbsp;   <?php echo $this->langSite('upload_video') ?>   </span>`);
        },
    ...
    (function($){
        $.fn.loaddata = function(options) {// Settings
            var settings = $.extend({
                ...
                data_url 		: '<?php  echo  url .'/'. $this->folder ?>/load/video', //url to PHP page
        ...
        function contents(el, settings){
            var load_img = $('<img/>').attr('src',settings.loading_gif_url).addClass('loading-video'); //create load video
            var record_end_txt = $('<div/>').text(settings.end_record_text).addClass('end-record-info'); //end record text

            if(loading == false && end_record == false){
                loading = true; //set loading flag on
                el.append(load_img); //append loading video

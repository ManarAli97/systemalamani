...
<?php  foreach ($car as $shop) { ?>
    <div class="row item_row delete_item_row_<?php  echo $shop['id'] ?>" id="item_row_<?php  echo $shop['id'] ?>">
        ...
        <div class="col">
            <div class="size_item">
                <span> <?php  echo $shop['title'] ?>  </span> &nbsp;    <input class="number_item_buy number_item_buy_<?php  echo $shop['id'] ?> number_item_buy_<?php  echo $shop['id'] ?>" id="count_buy_<?php  echo $shop['id'] ?>" type="text"  value="<?php  echo $shop['number'] ?>" readonly>
            </div>

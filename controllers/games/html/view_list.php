...
<?php  } else {  ?>
    <?php  $this->publicHeader($this->langSite('games'));  ?>
<?php } ?>
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                ...
                <br>
                    ...
                    <nav aria-label="breadcrumb" class="path_bread">
                        <ol class="breadcrumb">
                            ...
                            <?php  } } ?>
                            <?php  } else {  ?>
                                <li class="breadcrumb-item active">  <?php echo $this->langSite('games') ?>  </li>
               ...
               .swiper-slide li {
                ...
                <div class="swiper-container" id="scroll-tags">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <ul class="tags-list">
                              ...
                              <?php  foreach ($class_games as $clgame) {  ?>
                                <li><a class="btn class_games" id="class_games_<?php  echo $clgame['id']?>" onclick="class_games(<?php  echo $clgame['id']?>)">  <?php  echo $clgame['title']?> </a></li>
                                <?php  }  ?>
                    ...
                    <script>
                        ...
                        function class_games(id) {


                            $('.class_games').removeClass('active');
                            $('#class_games_'+id).toggleClass('active');

                            $('.loading_range').html(' <img  src="<?php echo $this->static_file_site ?>/image/site/loding.gif" >');
                            $.get( "<?php  echo url .'/'.$this->folder?>/class_games/"+id+"/<?php echo $id ?>", function( data ) {
                                $('.loading_range').empty();
                                if (data)
                                {
                                    $('.range_data').html(data)

...
<form  id="randomInsert"  action="<?php echo url.'/'.$this->folder ?>/add_class_games" method="post"  >
    ...
    <br>
    <a class="btn btn-success addPs" id="clickme"> <?php echo  $this->langControl('add_class_games')?> <i class="fa fa-plus-circle"></i> </a>
    <br>

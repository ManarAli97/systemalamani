<?php $this->publicHeader($result['title']); ?>
            ...
            <div class="col-lg-3">
                ...
                <script>
                    ...
                    function  like_d(id) {
                        ...
                        $.get('<?php echo url ?>/network/like_d/'+id, function(data){
                            if (data==='done')
                            {
                    ...
                    function  unlike_d (id) {
                        ...
                        $.get('<?php echo url ?>/network/unlike_d/'+id, function(data){
                            if (data==='done')
                            {
                    ...
                    <div class="details_network">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="details_info_network">
                                    ...
                                    <div class="choose_color_network">
                                        <div class="t_d_m">
                                            اختيار التفاصيل
                                        </div>
    ...
    <style>
        ...
        .image_network_show img.image_user {
            height: 350px;
            max-width: 100%;
        }

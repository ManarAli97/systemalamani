    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><?php  echo $this->langControl('edit_group') ?> </li>
                <li class="breadcrumb-item"><?php echo $data['name'] ?></li>
            </ol>
        </nav>
...
<form  action="<?php echo url ?>/user/edit_group/<?php echo $id  ?>" method="post">

    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/list_cover_material"><?php  echo $this->langControl('cover_material') ?> </a></li>
...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/add_cover_material" method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                        ...
                        <div class="row x_down">
                            ...
                            <div class="col-auto">
                                ...
                                <input   name="cover_material[]" type="text"  class="form-control " id="validationServer01"  value=""  required/>
                            </div>


                            <div class="col-auto">
                                <label for="validationServer2">  الرقم </label>
                                <input   name="number[]" type="number"  class="form-control " id="validationServer2"   value=""  required/>
                            </div>

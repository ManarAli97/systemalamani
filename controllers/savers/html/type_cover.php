...
<div class="row">
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/open_savers">  <?php  echo $this->langControl($this->folder)?>  </a></li>

                <li class="breadcrumb-item active" aria-current="page" >   تحديث  الاسم الاتيني  </li>
            </ol>
        </nav>
        <hr>
    </div>
...
<br>
        ...
        <form    action="<?php echo url.'/'.$this->folder ?>/type_cover"  method="post" enctype="multipart/form-data">

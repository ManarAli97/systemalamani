    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" > <?php  echo  $data['type_cover'] ?>  </li>
            </ol>
        </nav>
...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/edit_type_cover/<?php echo $id ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 align-self-end">
                            ...
                            <input   name="type_cover" type="text"   class="form-control " id="validationServer01"  value="<?php echo $data['type_cover'] ?>"  required/>
                        </div>

    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/list_feature_cover"><?php  echo $this->langControl('feature_cover') ?> </a></li>
...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/add_feature_cover" method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                        ...
                        <div class="row x_down">
                            ...
                            <div class="col-auto">
                                ...
                                <input   name="feature_cover[]" type="text"  class="form-control " id="validationServer01"  value=""  required/>
                            </div>

...
<nav>
	<div class="nav nav-tabs" id="nav-tab" role="tablist">
		<a class="nav-item nav-link active title_normal" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">   رفع ملف الاكسيل  </a>
...
<div class="tab-content" id="nav-tabContent">
	...
	<div class="tab-pane fade show active normal" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        يجب التأكد من وجود  مواقع في القسم قبل رفع ملف اكسل الباركودات . ليتم الربط

		<br>



		<form    action="<?php echo url.'/'.$this->folder ?>/add/<?php  echo $model?>"  method="post" enctype="multipart/form-data">

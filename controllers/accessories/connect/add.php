...
<div class="row">
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/list_accessories"><?php  echo $this->langControl('accessories') ?> </a></li>
...
<form action="<?php echo url.'/'.$this->folder ?>/add_accessories_connect" method="post">

...
<form action="<?php echo url.'/'.$this->folder."/edit_accessories_connect/$id." ?>" method="post">
...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="row">
            <div class="col-12">
                <label  > <span>    بحت عن اقسام متشابه في الواسق  </span>   </label>
            </div>
            <div class="col-12">
...
function add_c(id) {
    $.get( "<?php echo url.'/'.$this->folder ?>/accessories_info/"+id, function( data ) {

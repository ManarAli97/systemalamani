    ...
    <tbody>
       ...
       <?php if ($this->wcprice(1)) { ?>
        ...
        <tr>
            ...
            <td> <button type="button"  data-toggle="tooltip" data-placement="top" title="اضف للسلة"  type="button" class="btn btn-sm add_type_price"  id="price_device_1" onclick="addToCart_acce('<?php echo $result['code'] ?>',1)" >   <?php echo $wholesale_price    ?>   </button> </td>
       ...
       <?php if ($this->wcprice(2)) { ?>
        ...
        <tr>
            ...
            <td> <button type="button"  data-toggle="tooltip" data-placement="top" title="اضف للسلة"  type="button" class="btn btn-sm add_type_price"  id="price_device_2"  onclick="addToCart_acce('<?php echo $result['code'] ?>',2)" >   <?php echo $wholesale_price2    ?>   </button> </td>
       ...
       <?php if ($this->wcprice(3)) { ?>
        ...
        <tr>
            ...
            <td> <button type="button"  data-toggle="tooltip" data-placement="top" title="اضف للسلة"  type="button" class="btn btn-sm add_type_price"  id="price_device_3"  onclick="addToCart_acce('<?php echo $result['code'] ?>',3)" >   <?php echo $cost_price    ?>   </button> </td>

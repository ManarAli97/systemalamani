...
<?php  } else {  ?>
    <?php  $this->publicHeader($this->langSite('accessories'));  ?>
<?php } ?>
    <div class="container">
    <div class="row">
    <div class="col-lg-3">
            ...
            <ol class="breadcrumb">
              ...
              <?php     if (is_numeric($id)) { ?>
                <?php if ($breadcumbs){ foreach ($breadcumbs as $key => $bc) {   ?>
                  ...
                  <?php  } } ?>
              <?php  } else {  ?>
                  <li class="breadcrumb-item active">  <?php echo $this->langSite('accessories') ?>  </li>
    ...
    <script>
        ...
        function addToCart_acce(id,code,id_catgory = 0,id_catg_customer =0,price_type=0) {

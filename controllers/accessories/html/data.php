    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-6 xBoxG">
        ...
        <div  class="infoDevice">
         ...
         <?php
                ...
                foreach ($offers_acc as $offersItem){
            ...
            <a href="<?php echo url ?>/accessories/details/<?php echo $printContent['id'] ?>/<?php echo $printContent['id_catg_customer']?>"  >
                <div class="hoverBtn">
            ...
            <?php  if ($this->ch_wcprice() ) {  ?>
                <table class="table table-bordered table-striped table_wholesale_price">
                    ...
                    <?php if ($this->wcprice(1)) { ?>
                        ...
                        <tr>
                            <td>جملة</td>
                            <td> <button data-toggle="tooltip" data-placement="top" title="اضف للسلة"  type="button" class="btn btn-sm add_type_price"  onclick="addToCart_acce(<?php echo $printContent['id'] ?> ,'<?php echo $printContent['code'] ?>',1)" >  <?php echo $printContent['wholesale_price'] ?> </button> </td>
                    ...
                    <?php if ($this->wcprice(2)) { ?>
                        <tr>
                            <td>جملة الجملة</td>
                            <td> <button  data-toggle="tooltip" data-placement="top" title="اضف للسلة"  type="button"  class="btn btn-sm add_type_price"  onclick="addToCart_acce(<?php echo $printContent['id'] ?> ,'<?php echo $printContent['code'] ?>',2)" >  <?php echo $printContent['wholesale_price2'] ?> </button> </td>
                    ...
                    <?php if ($this->wcprice(3)) { ?>
                        <tr>
                            <td>التكلفة</td>
                            <td> <button  data-toggle="tooltip" data-placement="top" title="اضف للسلة"  type="button"  class="btn btn-sm add_type_price"  onclick="addToCart_acce(<?php echo $printContent['id'] ?> ,'<?php echo $printContent['code'] ?>',3)" >  <?php echo $printContent['cost_price'] ?> </button> </td>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-auto   xcartp"  >
                        ...
                        <?php if (isset($_SESSION['username_member_r']) || $this->isDirect()) { ?>
                            <?php if ($this->phone=='true' || $this->isDirect()) {   ?>
                                <button type="button" class="btn btn_cart" onclick="addToCart_acce(<?php echo $printContent['id'] ?> ,<?php echo $printContent['code'] ?>,<?php echo  $printContent['id_catg']; ?>,<?php echo  $printContent['id_catg_customer'] ?>)">

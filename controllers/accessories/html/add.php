...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/add_accessories/<?php echo $id ?>/<?php echo $r ?>" method="post" enctype="multipart/form-data">
            <div class="form-row">
                ...
                <div class="col">
                    ...
                    <div class="row x_down">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            ...
                            <input   name="code[]" oninput="check_code(this)" type="text"  class="form-control " id="validationServer01"  value=""  required/>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <label for="validationServer01"> <?php  echo $this->langControl('point') ?>  </label>
                            <input   name="point[]"   type="text"  class="form-control " id="validationServer01"  value=""   />
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <label for="validationServer0maximum"> <?php  echo $this->langControl('maximum') ?>  </label>
                            <input   name="maximum[]" type="text"  class="form-control " id="validationServer0maximum"  value=""   />
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <label for="validationServer0minimum"> <?php  echo $this->langControl('minimum') ?>  </label>
                            <input   name="minimum[]" type="text"  class="form-control " id="validationServer0minimum"  value=""   />
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <label for="validationServer01"> <?php  echo $this->langControl('name_color_in_crystal') ?>  </label>
                            <input   name="name_color[]" type="text"  class="form-control " id="validationServer01"  value="بلا"  required/>
                        </div>
...
<br>
                            <div class="row">
                                <div class="col-lg-12 tags_tags">
                                    ...
                                    <input   name="serial[]" type="text" class="form-control tags serial"     data-role="tagsinput" />
                                </div>
                            </div>

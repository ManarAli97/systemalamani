...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/edit_accessories/<?php echo $id ?>" method="post" enctype="multipart/form-data">
            <div class="form-row">
                ...
                <div class="col">
                    <?php  foreach ($color as $key => $c_data) {  ?>
                        <div class="row x_down removeRow_<?php  echo $c_data['id'] ?>">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12  align-self-end">
                                <label for="validationServer01"> <?php  echo $this->langControl('code') ?>  </label>
                                <input   name="code[<?php echo $c_data['id'] ?>]" type="text"  class="form-control" id="validationServer01"  value="<?php echo $c_data['code'] ?>"  required/>
                            </div>

                            <div class="col-lg-2 col-md-2 col-sm-12  align-self-end">
                                <label for="validationServer01"> <?php  echo $this->langControl('point') ?>  </label>
                                <input   name="point[<?php echo $c_data['id'] ?>]" type="text"  class="form-control" id="validationServer01"  value="<?php echo $c_data['point'] ?>"   />
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-12  align-self-end">
                                <label for="validationServer0maximum"> <?php  echo $this->langControl('maximum') ?>  </label>
                                <input   name="maximum[<?php echo $c_data['id'] ?>]" type="text"  class="form-control" id="validationServer0maximum"  value="<?php echo $c_data['maximum'] ?>"   />
                            </div>

                            <div class="col-lg-2 col-md-2 col-sm-12  align-self-end">
                                <label for="validationServer0minimum"> <?php  echo $this->langControl('minimum') ?>  </label>
                                <input   name="minimum[<?php echo $c_data['id'] ?>]" type="text"  class="form-control" id="validationServer0minimum"  value="<?php echo $c_data['minimum'] ?>"   />
                            </div>

                            <div class="col-lg-2 col-md-2 col-sm-12 align-self-end">
                                <label for="validationServer01"> لون كرستال </label>
                            ...
                            <div class="col-lg-1 col-md-2 col-sm-1 align-self-end">
                               ...
                               <br>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 tags_tags">
                                        <label for="validationServer0_serial">  ادخال البراكودات او السيريلات </label>
                                        <input   name="serial[<?php echo $c_data['id'] ?>]" type="text" class="form-control tags serial"   value="<?php echo $c_data['serial'] ?>"    data-role="tagsinput" />
                                    </div>
    ...
    $('.addPs').click(function() {
        ...
        $('.blockPs:last').before(`<div class="blockPs">
                             ...
                             <div class="col-lg-2 col-md-2 col-sm-12">
                               <label for="validationServer01"> <?php  echo $this->langControl('code') ?>  </label>
                               <input   name="code[newx${count}]"  oninput="check_code(this)"  type="text"  class="form-control " id="validationServer01"  value=""  required/>
                             </div>

                             <div class="col-lg-2 col-md-2 col-sm-12">
                               <label for="validationServer01"> <?php  echo $this->langControl('point') ?>  </label>
                               <input   name="point[newx${count}]"   type="text"  class="form-control " id="validationServer01"  value=""   />
                             </div>

                             <div class="col-lg-2 col-md-2 col-sm-12">
                               <label for="validationServer0maximum"> <?php  echo $this->langControl('maximum') ?>  </label>
                               <input   name="maximum[newx${count}]" type="text"  class="form-control  " id="validationServer0maximum"  value=""   />
                             </div>
                             <div class="col-lg-2 col-md-2 col-sm-12">
                               <label for="validationServer0minimum"> <?php  echo $this->langControl('minimum') ?>  </label>
                               <input   name="minimum[newx${count}]" type="text"  class="form-control  " id="validationServer0minimum"  value=""   />
                             </div>

                            <div class="col-lg-3 col-md-2 col-sm-12">
                                <label for="validationServer01"> <?php  echo $this->langControl('name_color') ?>  </label>
                                <input   name="name_color[newx${count}]" type="text"  class="form-control  " id="validationServer01"   value="بلا"  required/>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 mt-3 mb-3  align-self-end">
                                   <label style=" width: 100%;" for="validationServer0_image"> <?php  echo $this->langControl('image') ?>  </label>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                 <div class="col-lg-12 tags_tags">
                                <label for="validationServer0_serial">  ادخال البراكودات او السيريلات </label>
                                <input   name="serial[newx${count}]]" type="text" class="form-control tags serial"     data-role="tagsinput" />
                            </div>

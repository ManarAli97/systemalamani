...
<div class="row">
	<div class="col">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="<?php  echo url.'/'.$this->folder?>/list_location/<?php  echo $this->folder?>"><?php  echo $this->langControl($this->folder) ?> </a></li>
                <li class="breadcrumb-item active" aria-current="page" >  <?php  echo $this->folder?></li>
			</ol>
		</nav>
...
<nav>
	<div class="nav nav-tabs" id="nav-tab" role="tablist">
		<a class="nav-item nav-link show active  title_normal" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">   <span> رفع ملف الاكسيل مواقع قسم</span> <span><?php  echo $this->langControl($this->folder)?></span>  </a>
	...
	<div class="tab-pane fade  show active  normal" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
		...
		<form    action="<?php echo url.'/'.$this->folder ?>/add"  method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="model" class="form-control" id="exampleFormControlSelect1">

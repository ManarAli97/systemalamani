...
<div class="row justify-content-between">
	<div class="col-auto">
		<a class="btn btn-primary" href="<?php  echo url .'/'.$this->folder ?>/add/<?php  echo $this->folder ?>"> <i class="fa fa-plus"> <span>  رفع Excel </span></i>     </a>
	</div>
    ...
    <div class="col-auto">
        <?php 	if ($this->permit('delete_all_location', $this->folder)) { ?>
            <div class="text-left">
                <button class="btn btn-danger" onclick="delete_all('<?php  echo $this->folder ?>')"> <i class="fa fa-trash"></i> <span>حذف الكل</span></button>
            </div>
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                if (data==='1')
                {
                    ...
                    $('.xdata').val('')
                    alert('تمت الاضافة يرجى تحديث الصفحة ')
                }else {

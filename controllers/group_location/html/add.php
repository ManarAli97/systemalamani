...
<div class="row">
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('group_location') ?>  </li>
...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/add_group_location" method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                    ...
                    <div class="row x_down">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <input   name="title[]" type="text"  class="form-control " id="validationServer01"  value=""  required/>
                        </div>

                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <label for="validationServer-from">  من موقع  </label>
                            <input   name="from[]" type="text"  class="form-control " id="validationServer-to"  value=""  required/>
                        </div>

                            <div class="col-lg-4 col-md-4 col-sm-12">
                            <label for="validationServer-to">  الى موقع </label>
                            <input   name="to[]" type="text"  class="form-control " id="validationServer-to"  value=""  required/>
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-md-center ">
                    <div class="col-md-auto">
                        ...
                        <a class="btn btn-danger" href="<?php  echo url .'/'.$this->folder ?>/list_group_location" type="button" ><?php echo $this->langControl('close')?> </a>
...
<script>
    ...
    $('.addPs').click(function() {
        ...
        $('.blockPs:last').before(`<div class="blockPs">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <label for="validationServer-from">  من موقع      </label>
                                <input   name="from[]" type="text"  class="form-control " id="validationServer-from"  value=""  required/>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <label for="validationServer-to">  الى موقع      </label>
                                <input   name="to[]" type="text"  class="form-control " id="validationServer-to"  value=""  required/>

...
<div class="section_1">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8" >
                ...
                <div class="medical_supplies_list_her">
                    <span>  الاخبار  </span>
                </div>
                <br>
...
<div class="image_from_medical_supplies">
صور الخبر
</div>
...
<div class="col-12">
               ...
               <a class="btn top_view_medical_supplies">
                               احدث الاخبار
                            </a>
                            <div class="container_tab_slider">

                                <div id="carouselExampleIndicators_medical_supplies_hospital_new_medical_supplies"
                                     class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">

                                        <?php foreach ($new_medical_supplies_chunk as  $key => $array_chunk_medical_supplies) { ?>
                                        <div class="carousel-item <?php if ($key == 0) echo 'active' ?>  ">
                                            <div class="row">
                                                <?php foreach ($array_chunk_medical_supplies as $print_medical_supplies) { ?>
                                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                                        <a href="<?php  echo url .'/'.$this->folder ?>/details/<?php echo $print_medical_supplies['id'] ?>" class="image_medical_supplies_list">
                                                            <img src="<?php echo $print_medical_supplies['img'] ?>">
                                                        </a>
                                                        <div class="info_medical_supplies">
                                                            <div class="title_medical_supplies_list">
                                                                <?php echo $print_medical_supplies['title'] ?>

                                                            </div>
                                                            <div class="info_medical_supplies_publishing">
                                                                <span>   &nbsp;  <?php echo $print_medical_supplies['view'] ?>  </span>
                                                                <i class="fa fa-eye"></i> <span
                                                                        style="border-left: 1px solid #d0cccc; "></span>
                                                                &nbsp;
                                                                <span>      <?php echo $print_medical_supplies['date'] ?>   </span>
                                    ...
                                    <div class="control_slider_medical_supplies" style="margin-top: 13px;">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-auto" style="padding-left: 2px;padding-right: 0">
                                                    <a class="carousel-control-prev prev_and_prev"
                                                       href="#carouselExampleIndicators_medical_supplies_hospital_new_medical_supplies"
...
<style>
    ...
    .medical_supplies_list_her span {
        border-bottom: 0px solid #00a3c8;
        font-size: 22px;
        padding: 0px 55px 0 54px;
        position: relative;
    }
    .medical_supplies_list_her span:after {
        content: '___';
        position: absolute;
        width: 100%;
        text-align: center;
    ...
    .list_last_medical_supplies
    {
        margin-bottom: 9px;
        display: block;
    }
    .list_last_medical_supplies:last-child {
        margin-bottom: 0;
    }
 ...
 <style>
       ...
       ul#pagination-demo li a
        ...
        .title_list_medical_supplies {
            margin-top: 24px;
        }
        .info_medical_supplies_list {
            position: absolute;
            bottom: 0;
            color: #a8a8a8;
        }

        .border_space_medical_supplies {
            border-bottom: 2px dotted;
            padding: 14px 0;
        }


        .image_list_medical_supplies img
        {
            width: 100%;
        }
        ...
        .content_tab_medical_supplies_hospital
        {

            padding-top: 30px;
        }

        .tab_medical_supplies_hospital.nav-tabs .nav-item.show .nav-link, .tab_medical_supplies_hospital.nav-tabs .nav-link.active {
            color:blue;
            background-color: transparent;
        }

        .tab_medical_supplies_hospital.nav-tabs .nav-item {
        ...
        .tab_medical_supplies_hospital.nav-tabs .nav-item.show .nav-link, .tab_medical_supplies_hospital.nav-tabs .nav-link.active:before {
            content: ' ___';
            position: absolute;
            width: 100%;
            text-align: center;
        ...
        a.btn.top_view_medical_supplies {
            background: #e56353;
            border-radius: 0;
            color: #ffffff;
        }
        ...
        .image_medical_supplies_list {
            display: block;


        }

        .image_medical_supplies_list img {
            width: 100%;
            height: 178px;

        }

        .info_medical_supplies_publishing {
            text-align: left;
        }

        .title_medical_supplies_list {
            margin-bottom: 9px;
            margin-top: 5px;
            height: 52px;
            overflow: hidden;

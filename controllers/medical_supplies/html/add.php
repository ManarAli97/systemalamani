        ...
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <?php  } } ?>
                    <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('Add_medical_supplies') ?>  </li>
                </ol>
            </nav>
...
<div class="col">
     ...
     <form action="<?php echo url.'/'.$this->folder ?>/add_medical_supplies/<?php echo $id ?>" method="post">
         <div class="form-row">
             <div class="col-md-6 mb-6 lg-6">
                 <label for="validationServer01"> <span>  اسم المادة </span> <span style="color: red;font-size: 14px;" id="title"></span>  </label>
                 <input   name="title" value="<?php echo  $data['title']  ?>" type="text"   class="form-control is-valid" id="validationServer01"  >
             </div>
         </div>
        ...
        <br>
         ...
         <div class="form-row">
             <div class="col-auto">
                 ...
                 <input name="date" type="datetime-local"  value="<?php echo  date('Y-m-d\TH:i:s', $data['date'])  ?>"  class="form-control is-valid" id="validationServer02" >
             </div>
         </div>

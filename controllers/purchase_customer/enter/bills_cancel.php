    ...
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">  فواتير شراء  ملغية  </li>
            </ol>
        </nav>
...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_bills_cancel/<?php   echo $from_date_stm .'/'.$to_date_stm  ?>",
            info:false,

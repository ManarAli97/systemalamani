...
<div class="row justify-content-between">
    ...
    <div class="col-auto">
        ...
        <form action="<?php echo url.'/'.$this->folder?>/export_group_enter" method="get">
            ...
            <div class="row align-items-end">
                ...
                <div class="col-auto">
                    ...
                    <a href="<?php echo url.'/'.$this->folder?>/export_group_enter" class="btn btn-success" ><i class="fa fa-refresh"></i></a>
                </div>
            </div>
...
<table class="table table-striped display d-table  set_text_table" id="example">
    ...
    <tr>
        ...
        <th scope="col"> سعر الشراء (دينار) </th>
        <th scope="col"> سعر التكلفة (دينار) </th>
        <th scope="col"> سعر البيع  ($) </th>
        <th scope="col"> رقم الفاتورة </th>
        <th scope="col"> رقم  فاتورة كرستال </th>
        <th scope="col"> اسم الزبون ،اسم الموظف المشتري ،اسم المحاسب، رقم فاتورة النظام الداخلي , ملاحظة </th>

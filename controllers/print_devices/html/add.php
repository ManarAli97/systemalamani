...
<div class="row">
    <div class="col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page" > <?php  echo $this->langControl('print_devices') ?>  </li>
...
<div class="row">
    <div class="col">
        ...
        <form action="<?php echo url.'/'.$this->folder ?>/add_print_devices" method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                    ...
                    <div class="row x_down">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <label for="validationServer01">  اسم الطابعة </label>
            ...
            <div class="container">
                <div class="row justify-content-md-center ">
                    <div class="col-md-auto">
                        ...
                        <a class="btn btn-danger" href="<?php  echo url .'/'.$this->folder ?>/list_print_devices" type="button" ><?php echo $this->langControl('close')?> </a>

...
<?php foreach ($data as $cat) { ?>
    ...
    <div class="card" >
        <a  href="<?php echo url ?>/printing_supplies/list_printing_supplies/<?php echo $cat['id'] ?>">
            ...
            <div class="row setting_padding_Col">
                <div class="col">
                    ...
                    <div class="dropdown-menu menu_drop" >
                        <a class="dropdown-item" href="<?php echo url ?>/printing_supplies/edit_category/<?php echo $cat['id'] ?>">تعديل القسم</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?php echo url ?>/printing_supplies/list_printing_supplies/<?php echo $cat['id'] ?>">عرض عناصر القسم</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?php echo url ?>/printing_supplies/add_printing_supplies/<?php echo $cat['id'] ?>">اضافة الى  القسم </a>
                    </div>
                    </div>
...
<script>
    ...
    $('#save').on('click',function () {
        var  id= $('#save').val();
        $.post( "<?php echo url ?>/printing_supplies/delete/"+id, function( data ) {
            $('.card_'+id).remove();
    ...
    function vis_cat(e,id) {
        ...
        $.get("<?php echo url ?>/printing_supplies/visible/"+vis+'/'+id, function(){ })
    }

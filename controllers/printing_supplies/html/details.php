<?php $this->publicHeader($result['title']); ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="phoneModel heddinSm" style="position: relative">
                    ...
                    <div class="control_slider control_slider_inside">
                        <div class="row">
                            ...
                            <div class="col-auto  ">
                                <?php echo $this->langSite('printing_supplies') ?>
                            </div>
                        </div>
                    </div>
                ...
                <script>
                    ...
                    function  like_d(id) {
                        ...
                        $.get('<?php echo url ?>/printing_supplies/like_d/'+id, function(data){
                            if (data==='done')
                            {
                    ...
                    function  unlike_d (id) {
                        ...
                        $.get('<?php echo url ?>/printing_supplies/unlike_d/'+id, function(data){
                            if (data==='done')
                            {
            ...
            <div class="col-lg-9">
                ...
                <form id="buy_form">
                    <div class="details_printing_supplies">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="image_printing_supplies_show">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="details_info_printing_supplies">
                                    ...
                                    <div class="choose_color_printing_supplies">
                                        <div class="t_d_m">
                                            اختيار التفاصيل
                                        </div>
    ...
    <style>
        .image_printing_supplies_show {
            text-align: center;
        }

        .image_printing_supplies_show img.image_user {
            height: 350px;
            max-width: 100%;
        }

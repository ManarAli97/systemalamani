<div class="tab-content contentTabPhoneModel" id="myTabContent">
        ...
        <div class="tab-pane   show active    " id="printing_suppliesCat_<?php echo $id ?>" role="tabpanel" aria-labelledby="printing_supplies-tab_<?php echo  $id  ?>">
            ...
            <div class="phoneModel">
                ...
                <div id="carouselExampleControlsPhone-<?php echo  $id  ?>" class="carousel slide" data-ride="carousel" >
                    <div class="carousel-inner" role="listbox">
                        ...
                        <?php  foreach ($category_printing_supplies as $index=> $content) { ?>

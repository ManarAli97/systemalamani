...
<script>
    ...
    $(document).ready(function() {
          ...
          table= $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_jard_and_correction_material",
            info:false,
...
<script>
    ...
    function get_serial_jard_and_correction(code,model,page) {
        ...
        $.get("<?php  echo url.'/'.$this->folder?>/get_serial_jard_and_correction/"+code+'/'+model+'/'+page, function(data){
           if (data)
           {
    ...
    function  delete_serial_jard_and_correction(id) {
        ...
        {
            $.get("<?php  echo url.'/'.$this->folder?>/delete_serial_jard_and_correction/"+id, function(data){
                if (data)
                {
                    $('#serial_'+id).remove()
                }

...
<script>
    $(document).ready(function() {
        ...
        var table= $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_jard_and_correction",
            info:false,
...
<div class="row">
    ...
    <div class="col-auto">
        <a href="<?php echo url .'/'.$this->folder?>/jard_and_correction_material"    class="btn btn-warning btn-sm"> <i class="fa fa-table" aria-hidden="true"></i>  <span>  تقرير الجرد </span> </a>
    </div>

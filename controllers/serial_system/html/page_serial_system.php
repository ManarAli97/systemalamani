...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo url .'/'.$this->folder ?>/processing_page_serial_system",
            info:false,
...
<script>
    ...
    function creat_page_jard() {
        ...
        {
            $.get( "<?php echo url .'/'.$this->folder?>/creat_page_serial_system", function( data ) {
                console.log(data)
                window.location="<?php echo url .'/'.$this->folder?>/generation/"+data
            });
        }return false

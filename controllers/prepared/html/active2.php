...
<nav  id="reloadPage">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        <a class="nav-item nav-link "  id="nav-profile-tab"    href="<?php echo url .'/'.$this->folder ?>" ><span>قيد التجهيز</span> <span id="notif" class="badge badge-danger">  <?php  echo $this-> all_notification_buy() ?>   </span></a>
    ...
    <div class="col-lg-3" >
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                <div class="userList">
                    <input type="text" onkeyup="searchCustomer()" id="searchCustomer" name="search" class="form-control" autocomplete="off" placeholder="بحث عن فاتورة او الاسم او رقم الهاتف ">

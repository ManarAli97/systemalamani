    ...
    <div class="col-12"  style="padding: 3px">
        <div class="print_bill_casher">
			<?php  if (!empty($requestPrint)) { ?>
                ...
                <div class="row justify-content-between">
                    <div class="col-auto">
                        <span>    عدد المواد: </span> <span>  <?php echo  $number_typeOffer ?>  </span>
                    </div>
                    <div class="col-auto">
                        <span>     مجموع الكمية : </span> <span>  <?php echo  $sum_materialOffer ?>  </span>
                    </div>
                    <div class="col-auto">
                   ...
                   <form  id="checkedCode"  action="<?php echo url .'/'.$this->folder ?>/tajhez" method="post">
                       ...
                       <div class="row justify-content-end">
                           ...
                           <div class="col-auto" style="margin-left: 5px">
                               <button type="submit" class="btn btn-warning" id="goOk" name="submit" value="submit">  تجهيز   </button>
                           </div>
                       </div>
                   </form>
                </div>
        ...
        // }
          ...
          code = $('#code_checked').val();
           setTimeout(function () {
            ...
            $.get( "<?php echo url .'/'.$this->folder ?>/alixcol/"+ id_user + "/" + code +  "/" + number_bill, function( response_data ) {
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    else if (data==='notFoundSerial')
                                    {
                                        ...
                                        $("#checkedCode").attr('action', "<?php echo url . '/' . $this->folder ?>/enterSerial2location");
                                        $("#addLocation").show().html(`<input type="text"   data-toggle="tooltip" data-placement="top" title="الموقع الاول + الموقع الثاني + الموقع الثالث ..." onblur="read_barcode_location(this)"  placeholder="الموقع الاول + الموقع الثاني" autocomplete="off"  class="form-control location_checked"  name="location" required> <div class="locationItem"></div>`);
                                        $.get("<?php  echo url . '/' . $this->folder?>/location_get", {
                                            code: codeGet,
                                            table: table
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: "<?php  echo url  .'/'.$this->folder?>/enterSerial2location",
                                            data:  {id_user:id_user,code:code,number_bill:number_bill,enter_serial:serialList}, // serializes the form's elements.
            ...
            <div class="result_data_mobile">
                <form id="addBySearchTitle" action="<?php  echo url  .'/'.$this->folder?>/add_item_to_order/<?php echo $result['id'] ?>" method="post"  >
                    ...
                    <div class="text-center">
                        ...
                        <button disabled id="save_data" class="btn btn-primary" type="submit"> ارسال الطلب الى المحاسب </button>

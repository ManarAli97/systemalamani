...
(function (h) {
    ...
    function vb(a) {
        var b = a.aoColumns, c = b.length, d = a.oFeatures, e = a.oPreviousSearch, f = a.aoPmobileCols, g, j = [], i,
            m, l, k = X(a);
        g = a._iDisplayStart;
    ...
    function ga(a, b, c) {
        var d = a.oPreviousSearch, e = a.aoPmobileCols, f = function (a) {
            d.sSearch = a.sSearch;
            d.bRegex = a.bRegex;
            d.bSmart = a.bSmart;
        ...
        if (a.oFeatures.bStateSave && !a.bDestroying) {
            var b = {
                ...
                columns: h.map(a.aoColumns, function (b, d) {
                    return {visible: b.bVisible, search: Bb(a.aoPmobileCols[d])}
                })
            };
        ...
        var d, e, f = a.aoColumns, b = function (b) {
            if (b && b.time) {
                ...
                if (-1 === h.inArray(!1, g) && (g = a.iStateDuration, !(0 < g && b.time < +new Date - 1E3 * g) && !(b.columns && f.length !== b.columns.length))) {
                    ...
                    if (b.columns) {
                        d = 0;
                        for (e = b.columns.length; d < e; d++) g = b.columns[d], g.visible !== k && (f[d].bVisible = g.visible), g.search !== k && h.extend(a.aoPmobileCols[d], Cb(g.search))
                    }
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                    ...
                    F(p, g, ["asStripeClasses", "ajax", "fnServerData", "fnFormatNumber", "sServerMethod",
                        "aaSorting", "aaSortingFixed", "aLengthMenu", "sPaginationType", "sAjaxSource", "sAjaxDataProp", "iStateDuration", "sDom", "bSortCellsTop", "iTabIndex", "fnStateLoadCallback", "fnStateSaveCallback", "renderer", "searchDelay", "rowId", ["iCookieDuration", "iStateDuration"], ["oSearch", "oPreviousSearch"], ["aoSearchCols", "aoPmobileCols"], ["iDisplayLength", "_iDisplayLength"]]);

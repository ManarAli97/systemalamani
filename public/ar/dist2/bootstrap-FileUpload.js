...
;(function ($, document, window, undefined) {
	...
	function formStructure (el) {
		...
		instance[el].btnAdd = $('<div class="btn btn-success fileupload-add"><input type="file" ' + (instance[el].options.multiFile === true ? 'multiple="multiple"' : void 0) + 'multiple   />  <span class="btnAddFile">  <i class="glyphicon glyphicon-plus"></i>&nbsp;اضافة </span> </div>');

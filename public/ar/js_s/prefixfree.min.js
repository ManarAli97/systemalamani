    ...
    if (window.addEventListener) {
        var e = window.StyleFix = {
            link: function (a) {
                ...
                var c = a.href || a.getAttribute("data-href"), d = c.replace(/[^\/]+$/, ""),
                    h = (/^[a-z]{3,10}:/.exec(d) || [""])[0], l = (/^[a-z]{3,10}:\/\/[^\/]+/.exec(d) || [""])[0],
                    g = /^([^?]*)\??/.exec(c)[1], m = a.parentNode, f = new XMLHttpRequest, n;
...
(function (k) {
    ...
    if (window.StyleFix && window.getComputedStyle) {
        ...
        (function () {
            var b = {}, c = [], d = getComputedStyle(document.documentElement, null),
